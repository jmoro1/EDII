...
int main(void)
{
    ...
    *pCRH |= (0x1 << PB14_MODE_BIT0); 
    *pCRH |= (0x0 << PB14_MODE_BIT1); //SETEO EL MODE DEL CRH CON 01 MODO OUTPUT MAX 10MHz
    *pCRH |= (0x0 << PB14_CNF_BIT0); 
    *pCRH |= (0x0 << PB14_CNF_BIT1); // SETEO EL CNF DEL CRH CON 00 GENERAL PURPOSE OUTPUT PUSH-PULL
    *pODR |= (0x1 << PB14_ODR_BIT); /*PONGO EN 1 EL BIT DEL ODR (OUTPUT DATA)    ((((((((((((((((LO PONGO EN 1 PORQUE NOSE SI TIENE TENSION POR DEFECTO))))))))))))))))
