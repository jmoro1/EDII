...
void GPIOInit(void){
    ...
    //SETEO REGISTROS DE SALIDA (LED) COMO 00 GENERAL PURPOSE OUTPUT Y OUTPUT CON 01 MODO OUTPUT MAX 10MHz
    GPIO_C->CRH |= ((0x1 << PC13_MODE_BIT0) | (0x0 << PC13_MODE_BIT1) | (0x0 << PC13_CNF_BIT0) | (0x0 << PC13_CNF_BIT1));

	GPIO_A->CRL |= ((0x1 << P5_MODE_BIT0) | (0x0 << P5_MODE_BIT1) | (0x0 << P5_CNF_BIT0) | (0x0 << P5_CNF_BIT1)); // LED 1
    GPIO_A->CRL |= ((0x1 << P6_MODE_BIT0) | (0x0 << P6_MODE_BIT1) | (0x0 << P6_CNF_BIT0) | (0x0 << P6_CNF_BIT1)); // LED 2
    GPIO_A->CRL |= ((0x1 << P7_MODE_BIT0) | (0x0 << P7_MODE_BIT1) | (0x0 << P7_CNF_BIT0) | (0x0 << P7_CNF_BIT1)); // LED 3
...
*/
			//for(volatile uint32_t i=0;i<50000;i++){};
	   		GPIO_C->ODR = (0x0 << PC13_ODR_BIT); 
			GPIO_A->ODR &= ~((0x1 << P5_ODR_BIT) | (0x1 << P6_ODR_BIT) | (0x1 << P7_ODR_BIT)) ;  
			// GPIO_A->ODR = (0x0 << 7); 
			for(volatile uint32_t i=0;i<500000;i++){};
			GPIO_C->ODR = (0x1 << PC13_ODR_BIT);
			GPIO_A->ODR |= ((0x1 << P5_ODR_BIT) | (0x1 << P6_ODR_BIT) | (0x1 << P7_ODR_BIT)) ; 
